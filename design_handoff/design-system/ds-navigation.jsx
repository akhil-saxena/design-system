...
function TreeItem({
	...
	return (
		<div>
			...
			{hasChildren && (
				<div
					style={{ height: open ? "auto" : 0, overflow: "hidden", transition: "height .15s ease" }}
				>
					{children}
				</div>
			)}
...
function CollapsibleSidebar() {
	...
	return (
		<div
			className="ds-collapsible-sidebar glass"
			style={{
				width: w,
		...
		>
			...
			>
				...
				>
					<span
						style={{ fontFamily: "var(--display)", fontWeight: 800, fontSize: 14, color: "#fff" }}
					>
						J
					</span>
				</div>
		...
		<div>
			<DSSubsection title="Collapsible Sidebar">
				<p style={{ fontSize: 12, color: "var(--ink-3)", marginBottom: 14, lineHeight: 1.5 }}>
					Click the chevron at the bottom to collapse. Icons remain visible; labels and badges hide.
			...
			<DSSubsection title="Tree Navigation">
				<p style={{ fontSize: 12, color: "var(--ink-3)", marginBottom: 14, lineHeight: 1.5 }}>
					Nested expandable tree with depth indentation, chevron rotation, and optional
					badges/counts.
				</p>
				<div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
					...
					<div>
						...
						<div
							className="glass"
							style={{ borderRadius: 14, padding: "8px 0", overflow: "hidden" }}
						>
							{[
								...
								<div
									key={i}
									className={`ds-tree-item ${item.active ? "active" : ""}`}
								...
								>
									<span
										style={{
											...
											height: 6,
											borderRadius: "50%",
											background: item.active ? "var(--amber)" : "var(--ink-5)",
											flexShrink: 0,
										}}
									/>
									<span style={{ flex: 1 }}>{item.label}</span>
									{item.badge && (
										<span className="ds-badge upcoming" style={{ fontSize: 8, padding: "1px 6px" }}>
											{item.badge}
										</span>
									)}
								</div>
