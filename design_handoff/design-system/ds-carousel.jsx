		...
		<div style={{ position: "relative", width: "100%" }}>
			<div
				style={{
					...
					borderRadius: 12,
					position: "relative",
					aspectRatio: variant === "image" ? "16/9" : "auto",
					minHeight: variant === "image" ? "auto" : 160,
				}}
			>
				<div
					style={{
					...
					{items.map((item, i) => (
						<div
							...
							style={{
								...
								background: item.bg || "var(--cream-2)",
								color: item.fg || "var(--ink)",
								padding: 24,
							}}
						>
							{variant === "image" ? (
				...
				{items.map((_, i) => (
					<div
						...
						style={{
							...
							height: 6,
							borderRadius: 3,
							background: i === idx ? "var(--amber)" : "var(--ink-5)",
							cursor: "pointer",
							transition: "all .2s",
						}}
					/>
		...
		<div>
			<DSSubsection title="Carousel & Slider">
				<p style={{ fontSize: 12, color: "var(--ink-3)", marginBottom: 14, lineHeight: 1.5 }}>
					Sequential content browsers. Use sparingly — when content is genuinely sequential and
					there's value in a temporal reveal.
				</p>
							...
							items={[
								{
									...
									subtitle: "The job hunt, with sanity intact",
									bg: "linear-gradient(135deg, #f59e0b, #b45309)",
									fg: "#fff",
								},
								{
									title: "Track every application",
									subtitle: "Kanban, list, calendar — your call",
									bg: "var(--ink)",
									fg: "var(--cream)",
								},
								{
									title: "Never miss a follow-up",
									subtitle: "Smart reminders for every stage",
					...
					<div style={{ width: "100%" }}>
						<Carousel
							...
							items={[
								{
									label: "Testimonial",
									title: '"Got my dream job in 6 weeks."',
									body: "JobDash kept me organized through 47 applications and 12 interviews.",
								},
								{
									label: "Case study",
									title: '"Cut my apply time by 70%"',
									body: "Templates, snippets, and a tracking workflow that actually works.",
								},
								{
									label: "Review",
									title: '"The only tool I needed."',
									body: "Replaced my spreadsheet, my Notion docs, and my Google Calendar reminders.",
								},
							]}
						/>
					</div>
