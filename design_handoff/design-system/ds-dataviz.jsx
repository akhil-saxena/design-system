		...
		<div>
			...
			<DSSubsection title="Relative Time">
				<p style={{ fontSize: 12, color: "var(--ink-3)", marginBottom: 12, lineHeight: 1.5 }}>
					Hover for exact timestamp. Auto-formats based on distance from now.
				</p>
					...
					{[
						{
							type: "info",
							icon: "ℹ",
							text: "Your trial project for Supabase starts May 8th. Prepare your development environment.",
						...
						},
						{
							type: "success",
							icon: "✓",
							text: "Application to Automattic submitted successfully.",
						...
						},
						{
							type: "warning",
							icon: "⚠",
							text: "Raycast take-home is due in 2 days. You haven't started yet.",
						...
						},
						{
							type: "error",
							icon: "✕",
							text: "Failed to sync with Google Calendar. Reconnect in Settings.",
