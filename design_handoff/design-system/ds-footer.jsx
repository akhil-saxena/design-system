		...
		>
			...
			>
				<div>
					...
					<p style={{ fontSize: 12, color: "var(--ink-3)", lineHeight: 1.5, marginBottom: 12 }}>
						The job search tool that keeps your sanity intact. Track every application, every
						conversation.
					</p>
				...
				{cols.map((c) => (
					<div key={c.title}>
						...
						<div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
							{c.links.map((l) => (
								<span key={l} style={{ fontSize: 12, color: "var(--ink-2)", cursor: "pointer" }}>
									{l}
								</span>
							))}
						</div>
		...
		<div>
			<DSSubsection title="Footers">
				<p style={{ fontSize: 12, color: "var(--ink-3)", marginBottom: 14, lineHeight: 1.5 }}>
					Page-bottom containers — from a quiet copyright bar to a full marketing footer to a sticky
					action bar.
				</p>
