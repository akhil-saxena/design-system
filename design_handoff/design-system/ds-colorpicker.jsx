		...
		<div>
			<DSSubsection title="Color Picker">
				<p style={{ fontSize: 12, color: "var(--ink-3)", marginBottom: 14, lineHeight: 1.5 }}>
					Gradient saturation/brightness area, hue bar, opacity slider, hex input, and preset
					swatches. Swatch strips show full tonal scales.
				</p>
				<div style={{ display: "grid", gridTemplateColumns: "260px 1fr", gap: 24 }}>
						...
						<div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 14 }}>
							...
							<div className="ds-field" style={{ width: 56 }}>
								...
								<input
									...
									value={`${opacity}%`}
									readOnly
									style={{ fontFamily: "var(--mono)", fontSize: 12, textAlign: "center" }}
								/>
							</div>
						</div>
					...
					<div>
						...
						<div style={{ display: "flex", gap: 8, alignItems: "flex-end" }}>
							...
							<button className="ds-btn ds-btn-sm" style={{ marginBottom: 1 }}>
								Apply
							</button>
						</div>
					</div>
