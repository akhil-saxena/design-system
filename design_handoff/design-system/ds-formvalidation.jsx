...
function FormValidationSection() {
	...
	if (form.email && !/\S+@\S+\.\S+/.test(form.email) && (touched.email || submitted))
		...
		<div>
			<DSSubsection title="Inline Validation">
				<p style={{ fontSize: 12, color: "var(--ink-3)", marginBottom: 14, lineHeight: 1.5 }}>
					Real-time field validation with error and success states. Errors appear on blur or submit.
					Green check confirms valid input.
				</p>
					...
					<div className="glass" style={{ borderRadius: 14, padding: 20 }}>
						...
						<div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
							...
							<div className="ds-field">
								...
								<input
									className={`ds-input ${errors.company ? "error" : ""}`}
							...
							<div className="ds-field">
								...
								<input
									className={`ds-input ${errors.role ? "error" : ""}`}
							...
							<div className="ds-field">
								...
								<div style={{ position: "relative" }}>
									<input
										className="ds-input"
										style={{
											borderColor: success.salary ? "var(--green)" : undefined,
											boxShadow: success.salary ? "0 0 0 3px rgba(34,197,94,.1)" : undefined,
											fontFamily: "var(--mono)",
										}}
										value={form.salary}
							...
							<div className="ds-field">
								...
								<div style={{ position: "relative" }}>
									<input
										className="ds-input"
										style={{
											borderColor: success.url ? "var(--green)" : undefined,
											boxShadow: success.url ? "0 0 0 3px rgba(34,197,94,.1)" : undefined,
										}}
										value={form.url}
							...
							<div style={{ display: "flex", gap: 8, marginTop: 4 }}>
								<button className="ds-btn amber" onClick={handleSubmit}>
									Submit
								</button>
								<button
									className="ds-btn ghost"
									onClick={() => {
										setForm({ company: "", role: "", email: "", salary: "", url: "" });
										setTouched({});
										setSubmitted(false);
									}}
								>
									...
									{[1, 2, 3, 4].map((i) => (
										<div
											...
											style={{
												...
												height: 4,
												borderRadius: 2,
												background: i <= 3 ? "var(--green-vivid)" : "var(--cream-2)",
