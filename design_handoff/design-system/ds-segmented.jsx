...
function SegCtrl({ options, value, onChange, size = "md", icons }) {
	...
	const sizeMap = {
		sm: { pad: "4px 12px", fs: 11, r: 6, gap: 2 },
		md: { pad: "6px 16px", fs: 12, r: 8, gap: 3 },
		lg: { pad: "9px 24px", fs: 14, r: 10, gap: 4 },
	};
		...
		<div>
			<DSSubsection title="Segmented Controls">
				<p style={{ fontSize: 12, color: "var(--ink-3)", marginBottom: 14, lineHeight: 1.5 }}>
					iOS-style toggle between options. Smooth sliding thumb animation. Supports icons, multiple
					sizes, and 2–4+ segments.
				</p>
				<div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
					...
					<StateRow label="With Icons">
						<SegCtrl
							...
							value={iconView}
							onChange={setIconView}
							icons={[gridIc, listIc, calIc]}
						/>
					</StateRow>
