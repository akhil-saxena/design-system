...
function SettingsScreen() {
	...
	return (
		...
		>
			{/* Sidebar */}
			<aside
				style={{ borderRight: "1px solid var(--rule)", padding: 20, background: "var(--surf-1)" }}
			>
				<div
					style={{ fontFamily: "var(--display)", fontWeight: 800, fontSize: 18, marginBottom: 4 }}
				>
					Settings
				</div>
				<div
				...
				{tabs.map((t) => (
					<div
						...
						style={{
							...
							color: tab === t ? "var(--cream)" : "var(--ink-2)",
			...
			<main style={{ overflowY: "auto", padding: 32 }}>
				...
				<p style={{ fontSize: 13, color: "var(--ink-3)", marginBottom: 28 }}>
					How you appear across JobDash and to employers.
				</p>
				...
				>
					...
					<div style={{ flex: 1 }}>
						...
						<div style={{ fontSize: 12, color: "var(--ink-3)" }}>
							sarah.marshall@email.com · Joined March 2024
						</div>
					</div>
					<span className="ds-btn">Change avatar</span>
					<span className="ds-btn ghost" style={{ color: "var(--red)" }}>
						Remove
					</span>
				</div>
		...
		>
			...
			>
				<div style={{ maxWidth: 540, width: "100%" }}>
					...
					<p style={{ fontSize: 14, color: "var(--ink-3)", marginBottom: 24, lineHeight: 1.55 }}>
						Pick all that apply. We'll tailor your dashboard around these goals.
					</p>
						...
						{[
							...
							>
								...
								>
									...
									<div className={`ds-checkbox ${o.on ? "checked" : ""}`}>
										{o.on && (
											<svg
												viewBox="0 0 24 24"
												width="11"
					...
					<div style={{ display: "flex", justifyContent: "space-between" }}>
						...
						<span className="ds-btn dark" style={{ padding: "10px 22px" }}>
							Continue →
						</span>
					</div>
				</div>
	...
	return (
		<div style={{ height: "100%", overflowY: "auto", background: "var(--cream)" }}>
			...
			>
				...
				<span className="ds-btn amber" style={{ padding: "8px 14px" }}>
					+ Add application
				</span>
			</div>
					...
					{[
						...
						>
							...
							<div
								style={{
									fontSize: 11,
									color: s.up ? "var(--green)" : "var(--ink-3)",
									marginTop: 8,
									fontWeight: 600,
								}}
							>
							...
							>
								...
								<div style={{ flex: 1 }}>
									<div style={{ fontSize: 13, fontWeight: 600 }}>
										{a.r} <span style={{ color: "var(--ink-3)", fontWeight: 500 }}>· {a.c}</span>
									</div>
							...
							>
								<div
									style={{
										...
										height: 44,
										borderRadius: 8,
										background: e.amber ? "var(--amber)" : "var(--cream-2)",
										display: "flex",
										flexDirection: "column",
										alignItems: "center",
										justifyContent: "center",
	...
	return (
		<div style={{ height: "100%", overflowY: "auto", background: "var(--cream)" }}>
			...
			>
				...
				<p style={{ fontSize: 14, color: "var(--ink-3)", maxWidth: 480, margin: "0 auto" }}>
					Free forever for individuals. Upgrade when you need more applications, AI features, or
					team plans.
				</p>
			</div>
				...
				{[
					...
					>
						...
						<div style={{ display: "flex", alignItems: "baseline", gap: 6, marginBottom: 16 }}>
							...
							<span
								style={{ fontSize: 12, color: p.highlight ? "var(--cream-3)" : "var(--ink-3)" }}
							>
								{p.sub}
							</span>
						</div>
							...
							{p.features.map((f) => (
								...
								>
									<svg
										...
										height="13"
										fill="none"
										stroke={p.highlight ? "var(--amber)" : "var(--green)"}
										strokeWidth="3"
										strokeLinecap="round"
										strokeLinejoin="round"
									>
	...
	return (
		<div>
			<DSSubsection title="Sample Product Screens">
				...
				>
					Real product pages composed entirely from this design system — no extra CSS, no off-system
					colors, no one-off components. These are the templates new pages should remix.
				</p>
