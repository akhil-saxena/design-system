  ...
  return (
    <div>
      ...
      <DSSubsection title="Navigation Rail">
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4, width: 56, background: 'var(--surf-2)', borderRadius: 12, padding: 8, border: '1px solid var(--rule)' }}>
          {[
      ...
      <DSSubsection title="Progress & Loading">
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div>
            ...
            <div style={{ fontFamily: 'var(--mono)', fontSize: 10, color: 'var(--green)', marginTop: 4 }}>78% · strong</div>
          </div>
