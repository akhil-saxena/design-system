...
function LightboxSection() {
	const items = [
		{
			title: "Resume",
			caption: "Senior Engineer Resume",
			meta: "PDF · 2 pages · 245 KB",
			bg: "linear-gradient(135deg, #f59e0b, #b45309)",
		},
		{
			title: "Portfolio",
			caption: "Design portfolio walkthrough",
			meta: "Image · 1920×1080",
			bg: "linear-gradient(135deg, #1d4ed8, #7c3aed)",
		},
		{
			title: "Cover letter",
			caption: "Stripe cover letter",
			meta: "PDF · 1 page · 89 KB",
			bg: "linear-gradient(135deg, #15803d, #047857)",
		},
		{
			title: "References",
			caption: "Reference list",
			meta: "PDF · 1 page · 45 KB",
			bg: "linear-gradient(135deg, #c42020, #7f1d1d)",
		},
	];
		...
		<div>
			<DSSubsection title="Lightbox">
				<p style={{ fontSize: 12, color: "var(--ink-3)", marginBottom: 14, lineHeight: 1.5 }}>
					Fullscreen overlay for inspecting media. Keyboard arrows navigate, Esc closes. Counter and
					progress strip orient the user.
				</p>
