...
function RichTextToolbar({ activeFormats = {} }) {
	...
	const strike = (
		...
		>
			...
			<path d="M17.5 7.5c0-2-1.5-3.5-5.5-3.5s-5.5 1.5-5.5 3.5c0 4 11 4 11 8 0 2-1.5 3.5-5.5 3.5s-5.5-1.5-5.5-3.5" />
		</svg>
	);
	const heading = (
		<span style={{ fontWeight: 800, fontSize: 13, fontFamily: "var(--display)" }}>H</span>
	);
	const ul = (
		<svg
			viewBox="0 0 24 24"
		...
		<div>
			<DSSubsection title="Rich Text Editor">
				<p style={{ fontSize: 12, color: "var(--ink-3)", marginBottom: 14, lineHeight: 1.5 }}>
					Formatting toolbar with bold/italic/lists/links. Includes word count footer and save
					action. Minimal variant omits the toolbar.
				</p>
				<div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
					...
					<div className="glass" style={{ borderRadius: 14, overflow: "hidden" }}>
						...
						<div className="ds-richtext-body" contentEditable suppressContentEditableWarning>
							<p>
								Write your <b>cover letter</b> here. Highlight key achievements and explain why
								you're excited about the role.
							</p>
							<ul>
								<li>
									Led migration of legacy system to <b>React</b>
								</li>
							...
							<p>
								...
								<a href="#" style={{ color: "var(--amber-d)", textDecoration: "underline" }}>
									engineering team
								</a>
								.
							</p>
