...
const SWATCHES = [
	{ name: "cream", value: "#fcfcfc", light: true },
	{ name: "cream-2", value: "#f4f4f4", light: true },
	{ name: "cream-3", value: "#f0f0f0", light: true },
	...
	{ name: "paper-warm", value: "#f4f4f4", light: true },
	...
	return (
		...
		>
			...
			>
				...
				>
					@akhil-saxena · design system · v1.6.0
				</div>
				<div
					style={{
						fontFamily: DISPLAY,
